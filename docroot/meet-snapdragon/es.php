	...
	<body>
				...
				<section id="loading" class="bg-white block">
					<div class="inner">
						...
						<div class="text-position">
							<h3 class="txtb">¿Alguna vez ha tenido que esperar a que se cargue una aplicación o un sitio web en su smartphone?</h3>
						</div>
					</div>
				</section>
				...
				<section id="difference" class="bg-grey block">
					<div class="inner">
						<div class="text-position">
							...
							<ul class="txtb">
								<li id="parallax1">Qué es Qualcomm</li>
								<li id="parallax2">La función del procesador en un smartphone</li>
								<li id="parallax3">Por qué los dispositivos Snapdragon ofrecen una experiencia móvil extraordinaria</li>
							</ul>
						</div>
						<div class="graphic-position">
				...
				<section id="earth" class="bg-black block">
					<div class="inner">
						<div class="text-position">
							...
							<p class="txtg">¡Qualcomm suministra <span class="thick">22 chips MSM cada segundo!</span> Desde que comenzamos, hemos enviado más de <span class="thick">15 mil millones de chips</span>. Lo que serían 2 chips por cada persona que habita el <span class="thick">planeta Tierra.</span></p>
						</div>
						<div class="graphic-position">
				...
				<section id="every-phone" class="bg-grey-grad block">
					<div class="inner">
						<div class="text-position center">
							...
							<p class="txtb">asegúrese de escoger un procesador con las funciones adecuadas</p>
						</div>
						<div class="graphic-position center multi-col">
							<div class="scrollx">
								<div id="speed_performance" class="three-row">
									<div class="sprite"></div>
									<p class="thick">Velocidad y rendimiento</p>
								</div>
								<div id="reliable_connectivity" class="three-row">
									<div class="sprite"></div>
									<p class="thick">Conectividad fiable</p>
								</div>
								<div id="long_battery_life" class="three-row last">
									<div class="sprite"></div>
									<p class="thick">Batería de larga duración</p>
								</div>
							</div>
					...
					<div class="inner">
						...
						<div class="graphic-position center txtw multi-col">
							...
							<div id="process_emails" class="four-row">
								<div class="sprite"></div>
								<p>correos electrónicos y calendarios</p>
							</div>
				...
				<section id="mobile-power" class="block">
					<div class="inner">
						<div class="text-position center">
							...
							<h5 class="txtw">Los procesadores Snapdragon están equipados con un chip de una inmensa potencia móvil en un sistema diminuto.</h5>
						</div>
					</div>
				</section>
				...
				<section id="multiple-tasks" class="bg-white block">
					<div class="inner">
						<div class="text-position center">
							...
							<p class="txtb">Los procesadores Snapdragon emplean distintos motores móviles, cada uno diseñado específicamente para una tarea.</p>
						</div>
					</div>
          <div id="qchips">
            <ul class="left">
              <li class="sen"><span class="img"></span>Sensores</li>
            ...
            <ul class="right">
              <li class="pwr"><span class="img"></span>Administración del<br />consumo energético</li>
              <li class="dis"><span class="img"></span>Pantalla</li>
              <li class="cam"><span class="img"></span>Cámara</li>
              <li class="sec"><span class="img"></span>Seguridad</li>
              <li class="con"><span class="img"></span>Conectividad</li>
            </ul>
            <div id="qffx"></div>
          </div>
				</section>
				...
				<section id="gpu-performance" class="bg-grey-rdl block">
					<div class="inner">
						<div class="text-position center">
							...
							<h3 class="txtb"><span class="thick">Snapdragon 600</span> con un rendimiento hasta <span class="thick txtr">29 veces más rápido</span> <sup>1</sup><br />
              <span class="thick">Snapdragon 800</span> con un rendimiento hasta <span class="thick txtr">43 veces más rápido</span> <sup>1</sup></h3>
						</div>
            <div class="graphic-position">
            	<ul>
              ...
              <li class="a330 txtw"><span class="fill"></span><span class="name">Adreno 330 / <span class="thick">Snapdragon 800</span></span></li>
					...
					<div class="inner">
						...
						<div class="graphic-position center">
							<div class="left three-floats">
								<p>Velocidad de descarga de datos<br /><b>Hasta 150 Mbps</b> <sup>2</sup></p>
							</div>
							...
							<div class="right three-floats">
								<p>Velocidad de carga de datos<br /><b>Hasta 50 Mbps</b> <sup>2</sup></p>
							</div>
					...
					<div class="inner">
						...
						<div class="video-box">
							<div class="video-button">
								...
								<p>Mire la prueba de la mantequilla</p>
							</div>
						</div>
				...
				<section id="features" class="bg-white block">
					<div class="inner">
						...
						<div class="text-position">
							<div id="connectivity">
								<h2 class="txtr">Conectividad</h2>
								<p class="txtb">Velocidad de descarga insuperable</p>
							</div>
							<div id="performance">
								<h2 class="txtr">Rendimiento</h2>
								<p class="txtb">Gráficos hasta 2 veces más rápidos</p>
							</div>
							<div id="longer-battery">
								<h2 class="txtr">Mayor duración de la batería</h2>
								<p class="txtb">Siempre activado, siempre conectado</p>
							</div>
							<div id="speed">
								<h2 class="txtr">Velocidad</h2>
								<p class="txtb">CPU de hasta 2,3 Ghz</p>
							</div>
						</div>
					</div>
				</section>
        ...
        <section id="proceed" class="bg-black block">
        	<div class="inner">
          	<div class="text-position center">
            	<div class="video-button">
								<h2><a href="assessment.html" class="txtw">Realice una <span class="thick">evaluación</span> <span class="sprite play"></span></a></h2>
							</div>
            </div>
          </div>
        </section>
				...
				<section id="legal" class="bg-red block">
					<div class="inner">
						<div class="text-position txtw">
							<h3>Footnotes</h3>
							<ol>
							<li>Que Adreno 200. Fuente: datos de QCT.</li>
							<li>Máxima Tasa de datos medida, velocidad real puede variar</li>
							</ol>
							<hr />
